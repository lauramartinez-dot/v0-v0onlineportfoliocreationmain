...
export const topSkills = [
  {
    icon: Clock,
    title: "I write documentation for complex topics (such as APIs)",
    description:
  ...
  {
    icon: Newspaper,
    title: "I build systems that make each new doc easier to publish than the last",
    description:
  ...
  {
    icon: Globe,
    title: "I write English meant to be translated",
    description:
