...
export const topSkills = [
  {
    icon: Clock,
    title: "I write documentation for complex topics (such as APIs and integrations)",
    description:
  ...
  {
    icon: Newspaper,
    title: "I build documentation systems meant to scale over time",
    description:
  ...
  {
    icon: Globe,
    title: "I write English documentation meant to be translated",
    description:
