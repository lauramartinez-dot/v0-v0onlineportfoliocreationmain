...
export const topSkills = [
  ...
  {
    icon: Globe,
    title: "International Career in 4 Countries",
    description:
...
export const coreSkills = [
  ...
  {
    icon: Briefcase,
    title: "Ability to operate as both hands-on writer and content manager",
    description:
...
export const beyondCoreSkills = [
  {
    ...
    link: "",
    skills: ["Cultural Intelligence", "Async Collaboration"],
  },
  {
    icon: Globe,
