  ...
  return (
    <>
      <div
        ...
        className="cursor-pointer rounded-xl bg-purple-300/20 border shadow-sm border-purple-300/30 hover:shadow-lg hover:shadow-primary/20 hover:border-primary/50 hover:bg-purple-300/30 hover:-translate-y-0.5 transition-all duration-300"
      >
    ...
    <section id="highlights" className="relative px-4 overflow-hidden py-[70px]">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="max-w-6xl mx-auto mt-20 flex flex-col md:flex-row items-center gap-6 md:gap-8">
          ...
          {/* Mission box - right */}
          <div className="relative rounded-2xl border-2 border-purple-300/30 bg-purple-300/20 px-8 py-7 shadow-lg shadow-purple-500/10 backdrop-blur-sm md:flex-1">
