    ...
    <section id="highlights" className="relative px-4 overflow-hidden pt-[40px] pb-[70px] mt-[80px]">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div id="top-differentiators" className="mb-16 mt-[120px] scroll-mt-20">
          <h2 className="mb-10 text-3xl font-bold tracking-tight md:text-4xl text-center">Why Me?</h2>
          <div className="max-w-4xl mx-auto text-center space-y-4 mb-8">
            ...
            <p className="text-[21px] text-foreground/70 leading-relaxed">As a Senior Technical Writer though, writing is just part of what I do:</p>
          </div>
        </div>
