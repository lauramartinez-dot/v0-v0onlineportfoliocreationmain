  ...
  return (
    <>
      <div
        ...
        className="cursor-pointer rounded-xl bg-purple-100/90 border shadow-sm border-purple-200 hover:shadow-lg hover:shadow-primary/20 hover:border-primary/50 hover:bg-purple-50 hover:-translate-y-0.5 transition-all duration-300"
      >
        <div className="flex items-center gap-3 px-5 py-4">
          <div className="flex shrink-0 items-center justify-center rounded-lg bg-primary/15 h-10 w-10">
            <item.icon className="h-5 w-5 text-primary" />
          </div>
          <h4 className="font-semibold text-gray-800 text-lg md:text-xl leading-tight flex-1">{item.title}</h4>
        </div>
      </div>
    ...
    <section id="highlights" className="relative px-4 overflow-hidden py-[70px]">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="max-w-6xl mx-auto mt-20 flex flex-col md:flex-row items-center gap-6 md:gap-8">
          ...
          {/* Mission box - right */}
          <div className="relative rounded-2xl border-2 border-purple-200 bg-purple-100/90 px-8 py-7 shadow-lg shadow-purple-500/10 backdrop-blur-sm md:flex-1">
            ...
            <p className="text-base md:text-lg leading-relaxed text-gray-800 font-medium text-left text-balance mt-1">
