    ...
    <section id="highlights" className="relative px-4 overflow-hidden py-[70px]">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="max-w-6xl mx-auto mt-32 flex flex-col md:flex-row items-center gap-6 md:gap-8">
          ...
          {/* Mission box - right */}
          <div className="relative rounded-2xl border-2 border-primary/40 bg-gradient-to-br from-purple-900/70 via-purple-800/50 to-pink-900/70 shadow-2xl shadow-primary/30 backdrop-blur-md md:flex-1 ring-1 ring-white/10 px-12 py-12">
            ...
            <div className="absolute -top-4 left-10 flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 shadow-lg shadow-purple-500/40 ring-4 ring-background">
              <Rocket className="w-4 h-4 text-white" />
              <span className="text-sm font-semibold uppercase tracking-wider text-white">Mission</span>
            </div>
            <p className="text-lg md:text-xl leading-loose text-white/90 font-medium text-left text-balance mt-2 relative z-10">
