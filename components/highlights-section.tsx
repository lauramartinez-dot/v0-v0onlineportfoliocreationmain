      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div id="top-differentiators" className="mb-16 mt-[200px] scroll-mt-20">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6 mb-8">
            <p className="text-lg md:text-xl text-foreground/80 leading-relaxed">In general terms, <span className="text-white font-medium">I write about complex technology and software in the simplest, least <em>jargony</em> way possible</span>. This was at the core of every role I{"'"}ve held for the past 15 years.</p>
