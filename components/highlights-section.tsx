      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div id="top-differentiators" className="mb-14 mt-[120px] scroll-mt-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-8 text-xl md:text-2xl font-normal leading-relaxed text-foreground/80 text-balance">
        ...
        {/* Mission statement */}
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xl md:text-2xl font-normal leading-relaxed text-foreground/80 text-balance">
