    ...
    <>
      ...
      >
        <div className="flex items-center gap-3 px-5 py-4">
          ...
          <h4 className="font-normal text-foreground/70 text-base md:text-lg leading-tight flex-1" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>{item.title}</h4>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div id="top-differentiators" className="mb-16 text-center mt-[200px] scroll-mt-20">
          ...
          <div className="text-lg md:text-xl text-foreground/80 leading-relaxed max-w-4xl mx-auto space-y-6">
            <p className="whitespace-nowrap">In general terms, I write about complex technology and software in the <span className="text-white font-medium">simplest, least <em>jargony</em> way possible</span>.</p>
