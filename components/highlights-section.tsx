      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div id="top-differentiators" className="mb-14 mt-[120px] scroll-mt-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-8 text-xl md:text-2xl lg:text-3xl font-semibold tracking-tight leading-snug text-foreground text-balance">
              I wreck my head for hours understanding complex, daunting technology{" "}
              <span className="text-primary">so you don&apos;t have to.</span>
            </p>
            <p className="mt-5 text-lg md:text-xl font-medium leading-relaxed text-foreground/75 text-balance">
              Lately, that means APIs and integrations.
            </p>
            {/* Lead-in to the three cards, which act as the list itself */}
            <p className="mt-6 text-xl md:text-2xl lg:text-3xl font-semibold tracking-tight leading-snug text-foreground text-balance">
