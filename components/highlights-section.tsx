          ...
          <div className="max-w-6xl mx-auto mt-10 flex flex-col md:flex-row items-center gap-6 md:gap-8">
            ...
            <div className="flex items-start gap-5 rounded-2xl border border-primary/25 bg-gradient-to-r from-purple-50/80 to-pink-50/80 dark:from-purple-950/30 dark:to-pink-950/30 px-8 py-7 shadow-md shadow-primary/5 backdrop-blur-sm md:flex-1">
              ...
              <p className="text-lg md:text-xl leading-relaxed text-foreground/85 text-left">
                I help non-technical people make sense of technology — complex, jargon-filled, and sometimes a little gatekeepy. These days, knowing your way around new technology, especially software and AI tools, is basically what keeps you employed.
              </p>
            </div>
          </div>
        </div>
