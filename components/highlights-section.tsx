    ...
    >
      ...
      {beforeLabel && (
        <div className="absolute bottom-5 left-1/2 -translate-x-1/2 pointer-events-none z-10">
          <span className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border border-border/30 bg-background/90 backdrop-blur-md text-foreground text-base font-semibold shadow-lg whitespace-nowrap">
