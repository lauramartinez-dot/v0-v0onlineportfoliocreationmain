...
function SkillCard({
  ...
  return (
    <div className="flex h-full flex-col gap-5 rounded-xl border border-primary/20 bg-card/50 p-8">
      ...
      <h3 className="text-2xl md:text-[1.75rem] font-bold leading-snug text-foreground text-balance">
        {item.title}
      </h3>
    </div>
  )
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div id="top-differentiators" className="mb-14 mt-[120px] scroll-mt-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-8 text-3xl md:text-4xl font-medium tracking-tight leading-snug text-white/82 text-balance">
              I wreck my head for hours understanding complex, daunting technology{" "}
              <span className="text-primary">so you don&apos;t have to.</span>
            </p>
            <p className="mt-5 text-3xl md:text-4xl font-medium tracking-tight leading-snug text-white/79 text-balance">
              Lately, that means APIs and integrations.
            </p>
            {/* Lead-in to the three cards, which act as the list itself */}
            <p className="mt-6 text-3xl md:text-4xl font-medium tracking-tight leading-snug text-white/80 text-balance">
