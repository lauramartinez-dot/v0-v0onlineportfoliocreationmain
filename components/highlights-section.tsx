      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div id="top-differentiators" className="mb-16 mt-[120px] scroll-mt-20">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6 mb-8">
            <p className="text-lg md:text-xl text-foreground/80 leading-relaxed whitespace-nowrap">When I'm asked what I do, the short answer is: I write about technology. But these days, it's a lot more than that:</p>
