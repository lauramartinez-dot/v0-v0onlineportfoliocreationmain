...
function ToolCard({ item }: { item: (typeof coreSkills)[number] }) {
...
export function TopToolsSection() {
  return (
    <section id="top-tools" className="relative px-4 py-20">
      <div className="mx-auto max-w-7xl">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Top Tools</h2>
