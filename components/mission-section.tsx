    ...
    <section className="relative py-20 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="relative">
          ...
          {/* Mission box - purple glass with white text, overlaps bottom right corner */}
          <div className="relative lg:absolute lg:-right-8 lg:-bottom-8 w-full lg:w-[45%] mt-6 lg:mt-0 z-10">
            <div className="relative rounded-2xl border border-purple-400/30 bg-gradient-to-br from-purple-900/95 via-purple-800/90 to-purple-900/95 shadow-2xl shadow-purple-900/50 backdrop-blur-xl px-7 pt-8 pb-6">
              {/* Soft inner glow */}
              <div className="absolute inset-[1px] rounded-2xl bg-gradient-to-b from-white/10 to-transparent pointer-events-none" />
              
              {/* Mission badge */}
              <div className="absolute -top-4 left-7 flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 shadow-lg shadow-purple-500/40 ring-2 ring-purple-900/80">
              ...
              <p className="text-sm text-purple-200/70 italic text-right relative z-10">
