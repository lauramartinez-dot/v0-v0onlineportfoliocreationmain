...
const oooActivities = [
  ...
  },
  {
    ...
    description:
      "I am very active in Women in Tech communities (lately, MOXIE). I co-founded Personio's Women Committee and hosted several events to foster knowledge sharing.",
    image: "/ooo-women.jpg",
  },
]
