          ...
          <div className="flex-1 text-center md:text-left order-2 animate-slide-in-right">
            ...
            <div className="mb-8 text-lg md:text-xl text-foreground/70 leading-relaxed font-normal space-y-4">
              ...
              <p className="md:w-[120%]">
                Right when documentation stops being about adding more now,<br />and becomes about <span className="relative group/tooltip cursor-pointer text-white font-semibold bg-primary/20 px-1.5 py-0.5 rounded border-b-2 border-dashed border-primary/50 hover:bg-primary/30 hover:border-primary transition-all duration-200">making sure you can add a lot more later <span className="inline-flex items-center justify-center w-4 h-4 text-[10px] rounded-full border border-primary/50 text-primary/70 group-hover/tooltip:border-primary group-hover/tooltip:text-primary transition-all">?</span><span className="absolute left-full top-1/2 -translate-y-1/2 ml-3 px-3 py-2 bg-primary/90 border border-primary rounded-lg text-sm text-white whitespace-nowrap opacity-0 group-hover/tooltip:opacity-100 transition-opacity duration-200 pointer-events-none shadow-lg shadow-primary/30 z-50">Way more pages.<br /> With more visuals.<br /> For more audiences.<br /> In more languages.</span></span>.
              </p>
            </div>
