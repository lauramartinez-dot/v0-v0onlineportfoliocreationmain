...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    achievements: [],
    technologies: ["Leadership", "Technical Writing", "Career Development"],
    relevantSkills: ["Leadership", "Mentorship"],
    color: "#9931e7",
    icon: Award,
  },
  {
    id: "personio-senior-mentored",
    title: "Mentored Global Team Members",
    company: "Personio",
    workType: "Content operations",
    logo: "/personio-logo.png",
    headerImage: "/images/personio-team.jpg",
  ...
  },
  {
    ...
    title: "Guided Peer to Senior Promotion",
    company: "Personio",
    workType: "Content operations",
    logo: "/personio-logo.png",
    headerImage: "/images/personio-team.jpg",
  ...
  },
  {
    ...
    title: "Led Training Sessions & Workshops",
    company: "Personio",
    workType: "Content operations",
    logo: "/personio-logo.png",
    headerImage: "/images/personio-team.jpg",
    ...
    description:
      "Led training sessions and workshops (Miro, Google Slides) to upskill writers on new tools and processes.",
    achievements: [],
    technologies: ["Training", "Miro", "Google Slides", "Knowledge Transfer"],
    relevantSkills: ["Training & Development", "Presentation Skills"],
    color: "#9931e7",
    icon: Presentation,
  },
  {
    id: "personio-senior-leadership-alignment",
    title: "Partnered with Leadership on Metrics",
    company: "Personio",
    workType: "Content operations",
    logo: "/personio-logo.png",
    headerImage: "/images/personio-team.jpg",
    ...
    description:
      "Partnered with leadership to align content with key metrics: product adoption and customer retention.",
    achievements: [],
    technologies: ["Strategic Planning", "Data Analysis", "Product Metrics"],
    relevantSkills: ["Business Acumen", "Strategic Thinking"],
    color: "#9931e7",
    icon: Target,
  },
  {
    id: "personio-senior-ai-assistant",
    title: "AI Translation Review Assistant",
    company: "Personio",
    workType: "Content operations",
    logo: "/personio-logo.png",
    headerImage: "/images/personio-team.jpg",
    ...
    achievements: [],
    technologies: ["AI", "Automation", "Translation", "Process Optimization"],
    relevantSkills: ["AI-Driven Operations", "Process Improvement"],
    color: "#9931e7",
    icon: Bot,
  },
  {
    id: "personio-senior-deprioritize",
    title: "Enabled Task Deprioritization",
    company: "Personio",
    workType: "Content operations",
    logo: "/personio-logo.png",
    headerImage: "/images/personio-team.jpg",
    ...
    achievements: [],
    technologies: ["Data Analysis", "Process Optimization", "Resource Management"],
    relevantSkills: ["Data-Driven Decisions", "Process Improvement"],
    color: "#9931e7",
    icon: Filter,
  },
  {
    id: "personio-senior-content-removal",
    title: "Improved Content Relevance",
    company: "Personio",
    workType: "Content operations",
    logo: "/personio-logo.png",
    headerImage: "/images/personio-team.jpg",
    ...
    achievements: [],
    technologies: ["Content Audit", "Content Strategy", "Data Analysis"],
    relevantSkills: ["Content Strategy", "Data-Driven Decisions"],
    color: "#9931e7",
    icon: BarChart3,
  },
]
