...
export function AboutSection() {
  return (
    <section className="relative py-24 px-4 min-h-[400px]">
      ...
      <div className="absolute -right-[230px] md:-right-[290px] lg:-right-[340px] top-1/2 -translate-y-1/2 w-[620px] h-[620px] md:w-[800px] md:h-[800px] lg:w-[980px] lg:h-[980px] opacity-[0.18] mt-10">
        <Image
