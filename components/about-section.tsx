...
export function AboutSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-24 px-4 min-h-[400px] mt-[60px]">
      ...
      <div 
        className={`absolute -right-[280px] md:-right-[350px] lg:-right-[420px] top-1/2 -translate-y-1/2 w-[750px] h-[750px] md:w-[950px] md:h-[950px] lg:w-[1150px] lg:h-[1150px] opacity-20 mt-[60px] transition-all duration-[2000ms] ease-out ${
